...
def generate_random_user_agent(device_type='windows', browser_type='chrome'):
    chrome_versions = list(range(125, 128))
    ...
    if device_type == 'android':
        ...
        if browser_type == 'chrome':
            return (f"Mozilla/5.0 (Windows NT {windows_version}; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
                    f"Chrome/{browser_version} Safari/537.36 Edg/128.0.0.0")
        elif browser_type == 'firefox':
